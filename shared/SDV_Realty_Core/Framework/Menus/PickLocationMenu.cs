...
namespace SDV_Realty_Core.Framework.Menus
{
    internal class PickLocationMenu :  DialogueBox
    {
        ...
        //public PickLocationMenu(int x, int y, int width, int height)
        //{
        ...
        //public PickLocationMenu(string dialogue)
        //{
        //    if (Game1.options.SnappyMenus)
        //    {
        //        Game1.mouseCursorTransparency = 0f;
        ...
        //    setUpIcons();
        //}
        private PickListMenu picklist;
        public PickLocationMenu(string dialogue, PickListMenu  pickListMenu, Response[] responses, int width = 1200):base(dialogue,responses,width)
        {
            if (Game1.options.SnappyMenus)
            {
                Game1.mouseCursorTransparency = 0f;
