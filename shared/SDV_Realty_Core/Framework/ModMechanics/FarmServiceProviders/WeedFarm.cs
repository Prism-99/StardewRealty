...
{
    /// <summary>
    /// FarmServiceProvider that removes all weeds
    /// on an expansion.
    /// </summary>
    class WeedFarm : IFarmServiceProvider
    {
        ...
        public WeedFarm(IModDataService modDataService, IUtilitiesService utilitiesService) : base(modDataService, utilitiesService)
        {
            serviceCharge = 0.1f;
        }
